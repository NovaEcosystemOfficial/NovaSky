...
const registry = new Map([
  ...
  ["eq6-ascom", { id: "eq6-ascom", label: "EQ6 ASCOM/EQMOD (read-only)", protocol: "ascom", vendor: "EQASCOM / Sky-Watcher", status: "live-readonly-v0" }],
  ...
  ["eqmod", { id: "eqmod", label: "EQMOD", protocol: "eqmod", vendor: "EQMOD", status: "superseded-by-eq6-ascom" }],
  ["indi", { id: "indi", label: "INDI", protocol: "indi", vendor: "INDI", status: "planned" }],
  ["ascom", { id: "ascom", label: "ASCOM", protocol: "ascom", vendor: "ASCOM", status: "live-readonly-v0" }],
